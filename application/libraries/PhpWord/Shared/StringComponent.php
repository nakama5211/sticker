...
/**
 * Common stringComponent functions
 */
class StringComponent
{
     ...
     *
     * @param stringComponent $value Value to unescape
     ...
     *
     * @param stringComponent $value Value to escape
     * @return stringComponent
     */
    ...
    /**
     * Check if a stringComponent contains UTF-8 data
     *
     * @param stringComponent $value
     * @return boolean
     */
     ...
     *
     * @param stringComponent $text UTF8 text
     * @return stringComponent Unicode text
     * @since 0.11.0
     */
