            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        <h3 class="control-label">Thêm Dự Án</h3>
                    </header>
                        <div class="panel-body">
                            <form class="form-horizontal bucket-form" enctype="multipart/form-data"  id="add-form" method="post" action="<?php echo base_url(); ?>admin/admin/insert_project/">
                                <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" />
                                 <input type="hidden" name="id" value="">
                                 <div class="form-group">
                                    <label class="col-sm-3 control-label">Tên dự án</label>
                                    <div class="col-sm-6">
                                         <input type="text" name="name_project" value="" class="form-control" placeholder="Nhập tên dự án" required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div id="donhang" style="display: none;">
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                         <input type="text" name="so_luong" value="0" class="form-control so" >
                                    </div>
                                    <span>*Số lượng</span>
                                  </div>
                                  <div class="form-group">
                                ...
                                <div id="doanhthu" style="display: none;">
                                  ...
                                  <div class="form-group">
                                      <label class="col-sm-3 control-label"></label>
                                      <div class="col-sm-6">
                                           <textarea name="note_doanhthu" value="" class="form-control" placeholder="Ghi chú" ></textarea>
                                      </div>
                                  </div>
                                </div>
                                ...
                                <div id="chiphi" style="display: none;">
                                    ...
                                    <div class="form-group">
                                      <label class="col-sm-3 control-label"></label>
                                      <div class="col-sm-6">
                                         <input type="text" readonly="" value="0" name="chiphi_giay" id="chiphi_giay" class="form-control" >
                                      </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                             <input type="text" value="0" name="chiphi_inngoai" id="chiphi_inngoai" class="form-control so"  >
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                             <input type="text" value="0" name="chiphi_giacong" id="chiphi_giacong" class="form-control so"  >
                                        </div>
                                     ...
                                     <div class="form-group">
                                        <label class="col-sm-3 control-label"></label>
                                        <div class="col-sm-6">
                                             <input type="text" name="chiphi_giaohang" value="0" id="chiphi_giaohang" class="form-control so"  >
                                        </div>
