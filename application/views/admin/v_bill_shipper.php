              ...
              <div class="card-body" style="overflow-x:auto;">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                      ...
                      <?php 
                        if($row['status']==21) echo "<td>Đã thanh toán</td>";
                        else if($row['status']==20) echo '<td style="background-color: rgba(0, 0, 255, 0.25);"> Chưa thanh toán</td>';
...
<script type="text/javascript">
  function checkRow(id)
    {
        ssi_modal.confirm({
        content: 'Xác nhận đơn hàng này đã hoàn thành?',
        okBtn: {
        ...
        className:'btn btn-danger'
        ...
        },function (result) 
            {
                if(result)
                {
                    var route="<?= base_url()?>admin/admin/deliverySuccess/";
